...
var userAuthentication = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var user_token, decodedUser;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          //Getting Tokens to the user.
          user_token = req.headers.auth_token;
          if (user_token) {
            _context.next = 3;
            break;
          }
        ...
        case 3:
          _context.prev = 3;
          decodedUser = jwt.verify(user_token, process.env.JWT_SECRET_KEY); //Validation check for the decoded-user.
          if (decodedUser) {
            _context.next = 7;
            break;
          }
  ...
  return function userAuthentication(_x, _x2, _x3) {
